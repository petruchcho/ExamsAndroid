...
public class ExamSettingsActivity extends AbstractFragmentActivity {
	...
	protected Fragment createFragment() {
		UUID examId = (UUID) getIntent().getSerializableExtra(
				ExamSettingsFragment.EXTRA_EXAM_ID);
		SettingsType type = (SettingsType) getIntent().getSerializableExtra(
				ExamSettingsFragment.EXTRA_SETTINGS_TYPE);
